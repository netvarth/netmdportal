 ...
 * @author Luciya Jose
 */
public enum TestPropertyEnum implements Property, EnumDisplay {
	id("id","id","com.nv.youNeverWait.pl.entity.TestTbl","",""),
	uid("uid","uid","com.nv.youNeverWait.pl.entity.TestTbl","","");
	String displayName;
	String fieldName;
	String entityName;
	...
	private TestPropertyEnum(String displayName,String name,String entityName,String referenceName,String pathReferenceName){
