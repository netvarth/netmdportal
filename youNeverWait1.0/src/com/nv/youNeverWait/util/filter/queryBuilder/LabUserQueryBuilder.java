...
public class LabUserQueryBuilder extends RootQueryBuilder<LabUserTbl>{
	...
	public void addFilter(Filter filter) {
		String referenceName = LabUserPropertyEnum.valueOf(filter.getName()).getReferenceName();
		String pathReferenceName =LabUserPropertyEnum.valueOf(filter.getName()).getPathReferenceName();
		...
		Criteria criteria = filter.getPredicate(this, LabUserPropertyEnum.valueOf(filter.getName()));
