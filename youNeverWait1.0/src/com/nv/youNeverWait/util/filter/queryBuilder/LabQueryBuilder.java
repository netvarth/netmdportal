...
public class LabQueryBuilder extends RootQueryBuilder<LabTbl> {

	public LabQueryBuilder() {
	}
	...
	public void addFilter(Filter filter) {
		String referenceName = LabPropertyEnum.valueOf(filter.getName())
				.getReferenceName();
		String pathReferenceName = LabPropertyEnum.valueOf(filter.getName())
		...
		Criteria criteria = filter.getPredicate(this,
				LabPropertyEnum.valueOf(filter.getName()));
