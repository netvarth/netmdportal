...
public class Parity implements Cluster{

	  private AnalaticDao analaticDao;
	  private String name ="Parity";
		...
		public Inference getInference( String fmonth, String fyear,
				String toMonth, String toYear) {
				 ...
				 List<ParityEntity> entityList= analaticDao.getParityInferences(Integer.parseInt(fmonth),Integer.parseInt(fyear),Integer.parseInt(toMonth), Integer.parseInt(toYear));
		...
		public Inference getInference(String fmonth, String fyear,
		     ...
		     List<ParityEntity> entityList =analaticDao.getParityInferences(Integer.parseInt(fmonth),Integer.parseInt(fyear),Integer.parseInt(toMonth), Integer.parseInt(toYear),hosptl);
		     List<Measure> measures = getMeasures(entityList);
		     inference.setEvaluations(measures);
	    ...
	    private  List<Measure>  getMeasures(List<ParityEntity> data){
	    	List<Measure> measures = new ArrayList<Measure>();
	    	Measure measure;
	    	if ((data ==null) || data.size()==0)   return measures;
	    	for (ParityEntity entity :data){
