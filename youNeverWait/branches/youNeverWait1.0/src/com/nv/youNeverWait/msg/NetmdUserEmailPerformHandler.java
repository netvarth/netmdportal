/**
 * NetmdUserEmailPerformHandler.java
 *
 * Mar 27, 2013
 *
...
public class NetmdUserEmailPerformHandler implements
	...
	public void sendMsgPerformed(SendMailMsgObj obj) {
		...
		if (obj.getStatus().equals(SendMsgStatus.SUCCESS)) {
			System.out.println("Successfully send  netmd user registration email  - CALLBACK FUNCTION");
		} else if (obj.getStatus().equals(SendMsgStatus.FAILED)) {
			System.out.println("Failed to send netmd user registration email  - CALLBACK FUNCTION");
		}
	}
}
