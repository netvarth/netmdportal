...
$j(document).ready(function() {
	...
	/*$j('.Home').die('click').live("click",function(){
		...
		$j.get('/NetlimsPortal/ws/ui/lab/startUp', function(data){
		$j('html').html(data);
		});
	 ...
	 $j('.AboutNetlims').die('click').live("click",function(){
		...
		$j.get('/NetlimsPortal/ws/ui/lab/aboutNetLims', function(data){
		$j('html').html(data);
	...
	$j('.ContactUs').die('click').live("click",function(){
		...
		$j.get('/NetlimsPortal/ws/ui/lab/contactUs', function(data){
		$j('html').html(data);
		});
	});
	...
	$j('.Pricing').die('click').live("click",function(){
		...
		$j.get('/NetlimsPortal/ws/ui/lab/pricing', function(data){
		$j('html').html(data);
		});
	...
	$j('.PrivacyPolicy').die('click').live("click",function(){
		$j.get('/NetlimsPortal/ws/ui/lab/privacyPolicy', function(data){
		$j('html').html(data);
		});
	...
	window.location.href = "/NetlimsPortal/html/netlimsForgotPassword.html";
	});
	...
	$j('#btnLoginNetlims').die('click').live("click",function(){
		...
		if(validate()){
					...
					$j.ajax({
						type: "POST",
						url: serverPath + "/NetlimsPortal/ws/ui/auth/netlimsLogin",
						data: loginData,
	...
	function loginSuccess(data) {
		...
		//window.location.href = "/NetlimsPortal/html/netlimsIndex.html";
		location.reload();
		else
