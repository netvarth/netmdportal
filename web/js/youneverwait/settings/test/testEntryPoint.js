...
var pgTestList; 
$j.cachedScript("/youNeverWait/js/youneverwait/settings/test/testFunctions.js").done(function(script, textStatus) {
})
...
$j(document).ready(function(){
	...
	$j('#testPTBContainer #btn_new_ptb_id').die('click').live('click',function(){
		...
		$j.getScript("/youNeverWait/js/youneverwait/settings/test/new/newTest.js").done(function(script, textStatus) {
		})
	});	
	...
	$j('#testPTBContainer #btn_view_ptb_id').die('click').click(function(){
		...
		if(testId!="") {
			...
			$j.cachedScript("/youNeverWait/js/youneverwait/settings/test/view/viewTestEntryPoint.js").done(function(script, textStatus) {
