function validateNewtest(){
	...
	bValid = app.general.checkRegexp(remarks,/^[^"]*$/,constants_avoidDoubleQuotes) && bValid;
	bValid = app.general.checkRegexp(normalRange,/^[^"]*$/,constants_avoidDoubleQuotes) && bValid;
	/*if((isEmpty(name)))
