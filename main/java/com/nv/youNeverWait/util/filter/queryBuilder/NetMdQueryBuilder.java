...
public class NetMdQueryBuilder extends RootQueryBuilder<NetmdTbl>{

	public NetMdQueryBuilder(){
	}
	...
	public void addFilter(Filter filter) {
		String referenceName = NetMdPropertyEnum.valueOf(filter.getName()).getReferenceName();
		String pathReferenceName =NetMdPropertyEnum.valueOf(filter.getName()).getPathReferenceName();
		...
		Criteria criteria = filter.getPredicate(this, NetMdPropertyEnum.valueOf(filter.getName()));
