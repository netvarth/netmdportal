...
public class SyncServiceTest {
	...
	public void syncData() {
		...
		/*
		 * LoginDTO login1= new LoginDTO(); login1.setPassword("netvarth");
		 * login1.setUserName("ash"); login1.setUserType("doctor");
		 ...
		 * 
		 * LoginDTO login3= new LoginDTO(); login3.setPassword("netvarth");
		 * login3.setUserName("ranjith"); login3.setUserType("doctor");
		 * doctorDetail3.setLogin(login3); doctor.add(doctorDetail3);
		 */
		sync.setNewDoctorList(doctor);
		/*
		 * Update list List<DoctorDetail> upDoctor = new
		 * ArrayList<DoctorDetail>(); DoctorDetail doctorDetail4= new
		 * DoctorDetail(); doctorDetail4.setGlobalId(1);
		 * doctorDetail4.setEmail("ashly.pauly@netvarth.com");
		 * doctorDetail4.setId(1); List<DoctorExperienceDTO> doctorExperience4=
		 * new ArrayList<DoctorExperienceDTO>(); DoctorExperienceDTO docExp4 =
		 * new DoctorExperienceDTO(); docExp4.setDesignation("Senior Nurse");
		 * docExp4.setToDate("2012-10-10"); doctorExperience4.add(docExp4);
		 * doctorDetail4.setDoctorExperience(doctorExperience4);
		 * upDoctor.add(doctorDetail4);
		 * 
		 * 
		 * DoctorDetail doctorDetail5= new DoctorDetail();
		 * doctorDetail5.setGlobalId(2); doctorDetail5.setId(1);
		 * doctorDetail5.setFirstName("leonora");
		 * doctorDetail5.setEmail("leonora.louis@netvarth.com");
		 * List<DoctorExperienceDTO> doctorExperience5= new
		 * ArrayList<DoctorExperienceDTO>(); DoctorExperienceDTO docExp5 = new
		 * DoctorExperienceDTO(); docExp5.setDesignation("head Nurse");
		 * docExp5.setToDate("2012-10-10"); doctorExperience5.add(docExp5);
		 * doctorDetail5.setDoctorExperience(doctorExperience5);
		 * 
		 * List<DoctorAchievementDTO> doctorAcheivement5= new
		 * ArrayList<DoctorAchievementDTO>(); DoctorAchievementDTO docAch5 = new
		 ...
		 * upDoctor.add(doctorDetail5); sync.setUpdateDoctorList(upDoctor);
		 * Deletion List<DoctorDetail> delDoctor = new
		 * ArrayList<DoctorDetail>(); DoctorDetail doctorDetail6= new
		 * DoctorDetail(); doctorDetail6.setGlobalId(3); doctorDetail6.setId(3);
		 * delDoctor.add(doctorDetail6);
		 * 
		 * DoctorDetail doctorDetail7= new DoctorDetail();
		 * doctorDetail7.setGlobalId(2); doctorDetail7.setId(2);
		 * delDoctor.add(doctorDetail7); sync.setDeleteDoctorList(delDoctor);
		 */
		try {
			service.syncData(sync);
		} catch (ServiceException e) {
	...
	public void syncDoctorData() {
		...
		// List<DoctorExpertiseDTO> doctorExpertisee2 = new
		// ArrayList<DoctorExpertiseDTO>();
		// DoctorExpertiseDTO docExpt = new DoctorExpertiseDTO();
		...
		// List<DoctorExperienceDTO> doctorExperience4 = new
	...
	public void netLimsSyncData() {
		System.out
				.println("########## Sync retrieve Calling for Netlims... ################ ");
		SyncService service = (SyncService) applicationContext
				.getBean("sync.service");
	...
	public void retrieveAppointmentsForPrimary() {
		System.out
				.println("########## Sync retrieve appointments for primary... ################ ");
		SyncService service = (SyncService) applicationContext
				.getBean("sync.service");
		SyncDTO sync = new SyncDTO();
	...
	public void syncNetMdGynaData() {
		...
		sync.setHeader(header);
		List<CaseDTO> newCaseList= new ArrayList<CaseDTO>();
		...
		case1.setPatientType("outpatient");
