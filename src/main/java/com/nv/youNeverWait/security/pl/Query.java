...
public class Query {
	...
	public static final String GET_BY_PATIENT_NAME_AND_BRANCH_ID = "from PatientTbl as patient where UPPER(patient.firstName)=:param1 and UPPER(patient.lastName)=:param2 and patient.email=:param3 and patient.netmdBranchTbl.id=:param4";
	/* NetmdLoginTbl */
...
/********************Organizations**************/
	...
	/*UploadInstallerTbl*/
	public static final String GET_LATEST_VERSION_BY_SOURCE_TYPE ="from UploadInstallerTbl as uploadInstaller where uploadInstaller.id = (select MAX(uploadInstlr.id) from UploadInstallerTbl as uploadInstlr WHERE uploadInstlr.sourceType =:param1)";
	public static final String GET_UPLOADED_VERSIONS = "from UploadInstallerTbl as uploadInstaller where uploadInstaller.application_Name=:param1 and uploadInstaller.sourceType=:param2 ORDER BY uploadInstaller.createdDate DESC";
