/**
 * LabBranchRegistrationEmailPerformHandler.java
 *
 * Mar 27, 2013
 *
...
public class LabBranchRegistrationEmailPerformHandler implements
	...
	public void sendMsgPerformed(SendMailMsgObj obj) {
		...
		if (obj.getStatus().equals(SendMsgStatus.SUCCESS)) {
			System.out.println("Successfully send  lab branch registration email  - CALLBACK FUNCTION");
		} else if (obj.getStatus().equals(SendMsgStatus.FAILED)) {
			System.out.println("Failed to send lab branch registration email  - CALLBACK FUNCTION");
		}
	}
}
