 ...
 * @author Luciya Jose
 */
public class TransferredOrderQueryBuilder extends RootQueryBuilder<OrderBranchTbl>{

	public TransferredOrderQueryBuilder(){
	}
	...
	public void init(FilterDao dao) {
		super.init(dao, OrderBranchTbl.class);
	}
	...
	public void addFilter(Filter filter) {
		String referenceName = TransferredOrderPropertyEnum.valueOf(filter.getName()).getReferenceName();
		String pathReferenceName =TransferredOrderPropertyEnum.valueOf(filter.getName()).getPathReferenceName();
		...
		Criteria criteria = filter.getPredicate(this, TransferredOrderPropertyEnum.valueOf(filter.getName()));
