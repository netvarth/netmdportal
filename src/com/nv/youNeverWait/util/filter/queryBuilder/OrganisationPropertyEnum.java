 ...
 */
	...
	public enum OrganisationPropertyEnum implements Property, EnumDisplay{
		name("name","name","com.nv.youNeverWait.pl.entity.OrganisationTbl","",""),
		status("status","status","com.nv.youNeverWait.pl.entity.OrganisationTbl","",""),
		ownerName("ownerName","ownerName","com.nv.youNeverWait.pl.entity.OrganisationTbl","",""),
		ownerEmail("ownerEmail","ownerEmail","com.nv.youNeverWait.pl.entity.OrganisationTbl","","")
		;
		;
		String displayName;
		String fieldName;
		...
		private OrganisationPropertyEnum(String displayName,String name,String entityName,String referenceName,String pathReferenceName){
