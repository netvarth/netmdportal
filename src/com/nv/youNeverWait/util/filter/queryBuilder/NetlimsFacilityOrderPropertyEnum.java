 ...
 *
 */
public enum NetlimsFacilityOrderPropertyEnum implements EnumDisplay, Property {
	/**
	 * 
	 */
	id("id", "id", "com.nv.youNeverWait.pl.entity.FacilityResultTbl", "", ""),
	/**
	 * 
	 */
	 ...
	 * 
	 */
	//orderStatus("orderStatus","orderStatus","com.nv.youNeverWait.pl.entity.NetlimsOrderTbl","netlimsOrderTbl",""),
	loginId("loginId","id","com.nv.youNeverWait.pl.entity.LoginTbl","labFacilityTbl","loginTbl"),
	 ...
	 */
	private NetlimsFacilityOrderPropertyEnum(String displayName, String fieldName,
