...
public class ResultQueryBuilder extends RootQueryBuilder<ResultTbl>{
	...
	public void addFilter(Filter filter) {
		String referenceName = ResultPropertyEnum.valueOf(filter.getName()).getReferenceName();
		String pathReferenceName =ResultPropertyEnum.valueOf(filter.getName()).getPathReferenceName();
		...
		Criteria criteria = filter.getPredicate(this, ResultPropertyEnum.valueOf(filter.getName()));
