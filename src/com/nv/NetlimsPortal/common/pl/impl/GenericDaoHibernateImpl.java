 ...
 */
package com.nv.NetlimsPortal.common.pl.impl;
...
import com.nv.NetlimsPortal.common.pl.dao.GenericDao;
import com.nv.NetlimsPortal.exception.ServiceException;
import com.nv.NetlimsPortal.pl.entity.ErrorCodeEnum;
import com.nv.NetlimsPortal.pl.entity.PendingMessageTbl;
...
public class GenericDaoHibernateImpl implements GenericDao, SendMsgBaseDAO {
	...
	public List<Integer> getInqueueMsg(String type, String context) {
		Query query = em
				.createQuery(com.nv.NetlimsPortal.pl.query.Query.GET_INQUEUE_FROM_TABLE);
	...
	public List<Integer> getNewMsg(String type, String count, String context) {
		Query query = em
				.createQuery(com.nv.NetlimsPortal.pl.query.Query.GET_NEW_MSG);
		query.setParameter("param1", type);
		query.setParameter("param2", "youNeverWait");
	...
	public Long getNewMsgCount(String type, String context) {
		Query query = em
				.createQuery(com.nv.NetlimsPortal.pl.query.Query.GET_COUNT_NEW_FROM_TABLE);
		query.setParameter("param1", type);
		query.setParameter("param2", "youNeverWait");
		query.setParameter("param3", "NEW");
		List<PendingMessageTbl> pendingMessages = executeQuery(
